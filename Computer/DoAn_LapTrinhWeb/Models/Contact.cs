...
namespace DoAn_LapTrinhWeb.Models
{
    ...
    public class Contact
    {
        ...
        //Content
        [StringLength(200, ErrorMessage = "Nội dung gửi không được quá 100 ký tự", MinimumLength = 1)]
        [Required(ErrorMessage = "Nhập nội dung")]
        public string content { get; set; }
        [StringLength(500, ErrorMessage = "Ảnh không được quá 100 ký tự", MinimumLength = 1)]
        //Image
        public string image { get; set; }
        [StringLength(500, ErrorMessage = "Nội dung trả lời không được quá 100 ký tự", MinimumLength = 1)]
        //Reply
